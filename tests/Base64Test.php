...
final class Base64Test extends TestCase
{
    ...
    public static function provideEncodeCases(): iterable
    {
        ...
        foreach ([null, Base64::VARIANT_ORIGINAL] as $variant) {
            yield [$content, $variant, 'PiK4phmUx7y4/c6vjKSZHE9Rdp/wRAqbI/u80GeLMqZA76T/+9Pf+QYbPxz3dRi3mOr+ne5d7U74Yo+HPtjU7A=='];
        }

        yield [$content, Base64::VARIANT_ORIGINAL_NO_PADDING, 'PiK4phmUx7y4/c6vjKSZHE9Rdp/wRAqbI/u80GeLMqZA76T/+9Pf+QYbPxz3dRi3mOr+ne5d7U74Yo+HPtjU7A'];

        yield [$content, Base64::VARIANT_URLSAFE, 'PiK4phmUx7y4_c6vjKSZHE9Rdp_wRAqbI_u80GeLMqZA76T_-9Pf-QYbPxz3dRi3mOr-ne5d7U74Yo-HPtjU7A=='];
    ...
    public static function provideDecodeCases(): iterable
    {
        ...
        yield ['BDYIbBdXQcAjQpTC039N+hDvngft6n/W+d6YjaGy3XUoVnR79ZN0DDd8LkQVxMKVZu6uTIygLs8Hv+je/eYvYw', Base64::VARIANT_ORIGINAL_NO_PADDING, $content];

        yield ['BDYIbBdXQcAjQpTC039N-hDvngft6n_W-d6YjaGy3XUoVnR79ZN0DDd8LkQVxMKVZu6uTIygLs8Hv-je_eYvYw==', Base64::VARIANT_URLSAFE, $content];
